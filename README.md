...
<b>Step 1:</b> install navigator  <br />
``` navigator: 0.0.4 ```

<b>Step 2:</b> Create new folder ``lib\config``  <br />
<b>Step 3:</b> Create file in folder ``lib\config\route.dart`` <br />
...
<br />
<br />
<b> Step 4: </b> Register your route  <br />
